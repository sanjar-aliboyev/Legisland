...
export const metadata = {
  title: {
    ...
    default: 'Legisland - Professional Legal Services in Uzbekistan',
  },
  description: 'Expert legal consultation for corporate, civil, and economic law.',
  metadataBase: new URL('https://legisland.uz'), // Replace with your actual domain later
};
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              'name': 'Legisland',
              'url': 'https://legisland.uz', // Replace with your actual domain
              'logo': 'https://legisland.uz/logo.png', // Replace with your actual logo URL
