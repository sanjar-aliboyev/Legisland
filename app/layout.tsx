...
export const metadata: Metadata = {
  metadataBase: new URL('https://legisland.uz'),
  title: {
    default: "Legisland - Protecting Global Retail Giants",
    template: "%s | Legisland",
  },
  description: "Legisland specializes in Intellectual Property protection, brand security, and market analysis for global retail giants in Central Asia.",
  keywords: ["Intellectual Property", "Brand Protection", "Uzbekistan Law", "Retail Security", "Legisland", "Legal Services", "Central Asia"],
  openGraph: {
    title: "Legisland - Protecting Global Retail Giants",
    description: "Trusted by global brands to secure their intellectual property and market presence in Central Asia.",
    url: "https://legisland.uz",
    siteName: "Legisland",
    locale: "en_US",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Legisland - Brand Protection & Intellectual Property",
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Organization",
              "name": "Legisland",
              "legalName": "Legisland LLC",
              "url": "https://legisland.uz",
              "logo": "https://legisland.uz/Logo%20dark.png",
              "contactPoint": {
                "@type": "ContactPoint",
              ...
              "sameAs": [
                "https://www.facebook.com/legisland",
                "https://www.linkedin.com/company/legisland",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "Legisland",
              "legalName": "Legisland LLC",
              "image": "https://legisland.uz/og-image.jpg",
