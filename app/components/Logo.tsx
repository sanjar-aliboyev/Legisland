...
export default function Logo({ className = "" }: { className?: string }) {
  return (
    <div className={`legisland-logo ${className}`} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
      ...
      */}
      ...
      <span style={{ fontSize: '1.8rem', fontWeight: 900, letterSpacing: '-1px', fontFamily: 'var(--font-merriweather)', lineHeight: 1 }}>
        <span className="text-lex">Legis</span>
        <span className="text-corp">land</span>
      </span>
      ...
      <style jsx>{`
        ...
        :global(.footer-logo-container) .legisland-logo { color: #C5A059 !important; }
